...
<body>
	<head>
		<div id="header" style="width: 100%;height: 150px;background:url(<%=request.getContextPath()%>/img/header.jpg) no-repeat center center;background-size: cover;">
		</div>
		<div id="nav">
			<div class="nav_div">
				<a href="#"></a>
	...
	<section>
		<div id="lunbo">
			<ul class="lunbo_ul active">
				...
				<%-- <li class="li_0" style="background: url(<%=request.getContextPath()%>/img/lunbo_0.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0);"></a></li>
				<li class="li_1" style="background: url(<%=request.getContextPath()%>/img/lunbo_1.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0);"></a></li>
				<li class="li_2" style="background: url(<%=request.getContextPath()%>/img/lunbo_2.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0);"></a></li>
				<li class="li_3" style="background: url(<%=request.getContextPath()%>/img/lunbo_3.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0);"></a></li>
				<li class="li_4" style="background: url(<%=request.getContextPath()%>/img/lunbo_4.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0);"></a></li>
				<li class="li_5" style="background: url(<%=request.getContextPath()%>/img/lunbo_4.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0);"></a></li>
				<li class="li_6" style="background: url(<%=request.getContextPath()%>/img/lunbo_3.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0);"></a></li>
				<li class="li_7" style="background: url(<%=request.getContextPath()%>/img/lunbo_0.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0);"></a></li> --%>
			</ul>
			<div class="btn">
				<ul>
					<li></li>
	...
	<section>
		<div class="categoryList fl">
			...
			<c:forEach items="${goodsTypes}" var="item" varStatus="status"> 
				<li><a href="#"><i class="cateIcon" style="background:url(<%=request.getContextPath()%>/img/123.png) no-repeat; background-size:34px 34px;"></i><span>${item.goods_name }</span></a></li>
	...
	<div class="phoneExc fl">
					...
					<li style="width: 120px;">
						<a href="<%=request.getContextPath()%>/goods/selectGoodsById.action?id=${item.goods_id }"></a>
							<div class="pic picHeight">
								<img src="${item.goods_pictureUrl}" style="height: 120px;">
							</div>
							<div class="name">
								${item.goods_name} 
							</div>
		...
		<div class="interduce">
			<c:forEach items="${resultHotList}" var="item" varStatus="status"> 
				...
				<c:when test="${status.index%2 == 0}">
					<div class="pic_1">
						<div  class="pic_img pic_00" style="background:url(<%=request.getContextPath()%>/img/pic_1.jpg) no-repeat center center; background-size: cover;">
						<a href="<%=request.getContextPath()%>/goods/selectGoodsById.action?id=${item.goods_id }"></a>
						</div>
						<p>  ${item.goods_name}</p>
				...
				<c:otherwise>
					...
					<div class="pic_2">
						<div  class="pic_img pic_01" style="background:url(<%=request.getContextPath()%>/img/pic_1.jpg) no-repeat center center;background-size: cover;">
		...
		<div class="interduce">
			<c:forEach items="${resultNewList}" var="item" varStatus="status"> 
				...
				<c:when test="${status.index%2 == 0}">
					<div class="pic_1">
						<div  class="pic_img pic_00" style="background:url(<%=request.getContextPath()%>/img/pic_1.jpg) no-repeat center center; background-size: cover;"><a href="javaScript:void(0)"></a>
						</div>
						<p>  ${item.goods_name}</p>
						<h3>  ￥${item.goods_price }</h3>
					</div>
				...
				<c:otherwise>
					<div class="pic_2">
						<div  class="pic_img pic_01" style="background:url(<%=request.getContextPath()%>/img/pic_1.jpg) no-repeat center center;background-size: cover;"><a href="javaScript:void(0)"></a></div>
						<p>  ${item.goods_name}</p>
						<h3>  ￥${item.goods_price }</h3>
					</div>
				</c:otherwise>
